...
<div class="container">
    <div class="header">
        ...
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/servlet.LoginLogServlet">我的登录日志</a></li>
            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/servlet.UserActionLogServlet">系统操作日志</a></li>
